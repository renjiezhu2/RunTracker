...
//ProfileImageDialogFragment handles all the customized dialog boxes in our project.
...
public class ProfileImageDialogFragment extends DialogFragment {
    ...
    public static ProfileImageDialogFragment newInstance(int dialog_id) {
        ProfileImageDialogFragment frag = new ProfileImageDialogFragment();
